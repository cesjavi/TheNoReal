                ...
                >
                  ...
                  <div className="space-y-3">
                    <textarea
                      ...
                      className="h-40 w-full resize-none rounded-2xl border border-black/20 bg-white/80 p-4 text-base shadow-inner transition focus:border-accent-dark focus:outline-none focus:ring-2 focus:ring-accent"
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <label className="flex flex-col gap-2 rounded-2xl border border-black/10 bg-white/60 p-4 text-sm text-gray-700">
                      ...
                      <input
                        ...
                        className="rounded-xl border border-black/20 bg-white/80 p-2 text-base focus:border-accent-dark focus:outline-none focus:ring-2 focus:ring-accent"
                      />
                    </label>
